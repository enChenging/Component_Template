package com.release.annotation_compiler;
...
public class AnnotationCompiler extends AbstractProcessor {
    ...
    public Set<String> getSupportedAnnotationTypes() {
        ...
        types.add(BindPath.class.getCanonicalName());//包名+类名
        return types;
    }
        ...
        if(map.size() > 0){
            ...
            try {
                ...
                JavaFileObject sourceFile = filer.createSourceFile(
                        "com.release.rutil." + utilName);
                writer = sourceFile.openWriter();
                StringBuffer stringBuffer = new StringBuffer();
                stringBuffer.append("package com.release.rutil;\n");
                stringBuffer.append("import com.release.router.IRouter;\n");
                stringBuffer.append("import com.release.router.Router;\n");
